...
Breadcrumbs::register('adverts.inner_region',
    function (Crumbs $crumbs, Region $region = null, Category $category = null) {
...
Breadcrumbs::register('adverts.inner_category',
    function (Crumbs $crumbs, Region|null $region = null, Category|null $category = null) {
...
Breadcrumbs::register('cabinet.adverts.create.region',
    function (Crumbs $crumbs, Category $category, Region $region = null) {
        $crumbs->parent('cabinet.adverts.create');
        $crumbs->push($category->name, route('cabinet.adverts.create.region', [$category, $region]));
    });

Breadcrumbs::register('cabinet.adverts.create.advert',
    function (Crumbs $crumbs, Category $category, Region $region = null) {
